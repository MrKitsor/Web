...
export default {
  ...
  actions: {
    ...
    addItem: async ({ commit }, { popularity, holiday, date, category }) => {
      const item = await api.add({ popularity, holiday, date, category })
      commit('setItem', item)
    },
    updateItem: async ({ commit }, { id, popularity, holiday, date, category }) => {
      const item = await api.update({ id, popularity, holiday, date, category });
