<template>
  <div :class="$style.root">
    <Table
      :headers="[
        {value: 'id', text: 'ID'},
        {value: 'popularity', text: 'Уровень популярности'},
        {value: 'holiday', text: 'Название праздника'},
        {value: 'date', text: 'Дата праздника'},
        {value: 'category', text: 'Категория праздника'},
