<template>
  <div :class="$style.root">
    ...
    <div :class="$style.item">
      <div :class="$style.label">
        <label for="description">Описание праздника</label>
      </div>
      <input v-model="form.description" :class="$style.input" id="description" placeholder="Описание праздника" type="text">
    </div>
    <div :class="$style.item">
